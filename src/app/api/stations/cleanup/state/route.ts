...
// Single-event assumption: resolve the one event row, return the station
// snapshot — active tasks and per-event completion ids. Polling is out of
// scope; the station component fetches this once on mount.
