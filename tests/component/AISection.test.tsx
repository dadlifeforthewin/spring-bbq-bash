...
describe('AISection', () => {
  it('renders the AI disclosure text with the required clauses', () => {
    render(<AISection typedName="" setTypedName={() => {}} ack={false} setAck={() => {}} />)
  ...
  it('fires setAck when the checkbox is clicked', () => {
    const setAck = vi.fn()
    render(<AISection typedName="" setTypedName={() => {}} ack={false} setAck={setAck} />)
  ...
  it('fires setTypedName when the signature input changes', () => {
    ...
    render(<AISection typedName="" setTypedName={setTypedName} ack={false} setAck={() => {}} />)
